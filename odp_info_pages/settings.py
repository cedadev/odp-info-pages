"""
Django settings for odp_info_pages project.
...
ROOT_URLCONF = 'odp_info_pages.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['odp_info_pages/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'odp_info_pages.wsgi.application'
